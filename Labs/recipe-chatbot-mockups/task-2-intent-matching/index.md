---
layout: task
title: "Task 2: Evaluate Response Quality"
description: "For each customer query below, compare two AI responses and select the one that better satisfies the customer's need."
task_progress: "Task 2 of 5"
back_link: "../task-1-user-needs/index.html"
next_link: "../task-3-metrics-selection/index.html"
next_text: "Next: Task 3 →"
custom_styles: |
  body {
      max-width: 1000px;
  }
